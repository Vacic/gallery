				...
				<div class="col-md-9">
					<div class="thumbnails row">
						<?php foreach ($photos as $photo): ?>
							<div class="col-xs-2">
								<a role="checkbox" aria-checked="false" tabindex="0" id="" href="javascript: void();" class="thumbnail">
									<img src="<?php echo $photo->picture_path(); ?>" alt="" class="modal_thumbnails" data="<?php echo $photo->id; ?>">
								</a>
